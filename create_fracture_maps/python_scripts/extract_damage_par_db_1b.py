...
def save_damage_data(outpath, sar_data, date, damage_data):
    array_to_geotiff(damage_data[1,:,:], sar_data, outpath+"/{}.damage_probs_1b.tif".format(date), compression="DEFLATE")
...
if __name__ == "__main__":
    ...
    #process data
    damage_data = pipeline(sar_data_array)

    #I/O
    save_damage_data(outpath, sar_data, damage_data, date)
